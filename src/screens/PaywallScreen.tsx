    ...
    async (pack: PurchasesPackage) => {
      ...
      try {
        ...
        if (result.success) {
          ...
          Alert.alert(
            t('common.error'),
            result.error || t('paywall.purchase_error')
          );
        }
      } catch (error) {
    ...
    >
      ...
      <View style={styles.packagesContainer}>
        {loading ? (
                  ...
                  <View style={styles.packageContent}>
                    ...
                    <View style={styles.packageRight}>
                      ...
                      {pack.packageType === 'ANNUAL' && (
                        ...
                        >
                          {t('paywall.per_month', {
                            price: `$${(pack.product.price / 12).toFixed(2)}`,
                          })}
                        </Text>
                      )}
                    </View>
          ...
          >
            ...
            <Text
              style={[styles.noOffersSubtext, { color: theme.colors.outline }]}
            >
      ...
      <View style={styles.footer}>
        ...
        <View style={styles.legalLinks}>
          ...
          <Text
            style={[styles.legalSeparator, { color: theme.colors.outline }]}
          >
            •
          </Text>
